...
abstract: | 
 Juste quelques infos. La nouvelle version de Quarto est sortie le 07 janvier 2024: intégration de l'extension lightbox au logiciel, deux nouveaux formats (dashboard et manuscript), possibilité de mettre des cross reference aux encadrée callout.... 
---

* [[Téléchargement et notes de version]](https://quarto.org/docs/download/) 

Les quelques ajouts après un premier coup d'oeil.   
