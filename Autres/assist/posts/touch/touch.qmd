...
abstract: | 
  Originaire du système Linux, la commande `touch` permet de créer des fichiers vides très rapidement à partir d'un terminal ou d'une invite de commandes. Cette commande est embarquée dans RStudio, mais doit être installée  si on souhaite l'utiliser dans l'invite de commande windows (ou powershell) 
...
* On créer^[ici directement avec la commande `mkdir`] un répertoire (où l'on veut)  appelé *commande_touch* 
