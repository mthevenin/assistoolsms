...
*  Pour Coralie: plus facile d'utiliser `![](icone_extension_vscode.png)`
* Tu peux ajouter des options type réduire la taille `![](icone_extension_vscode.png){width=70%}`
* Ca permet d'appliquer des extensions à l'image, ici lightbox (pas utile ici pour les icônes)

![](icone_extension_vscode.png)  
